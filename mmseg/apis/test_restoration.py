...
def restoration_save(model, data_loader, out_root, output_prob=False,
    ...
    out_dir1 = osp.join(out_root, "sr_restoration")
    ...
    for data in data_loader:
        ...
        with torch.no_grad():
            result = model.slide_inference_restoration(indexs_list=[1],resize_list=[True],num_classes_list=[3], **data)
